...
/**
  * The Exchange service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the ExchangeService.
  */
trait ExchangeService extends Service {
  ...
  override final def descriptor = {
    ...
    named("exchange")
      ...
      .withTopics(
        topic(ExchangeService.TOPIC_NAME, greetingsTopic)
